...
export const mockUser = {
  ...
  bio: 'Музыкант, композитор, автор песен. Люблю экспериментировать со звуком.',
  avatar_url: 'https://i.pravatar.cc/300?u=user',
  banner_url: 'https://picsum.photos/1200/400?random=profile',
  telegram: 'https://t.me/anna',
  vk: 'https://vk.com/anna',
  youtube: 'https://youtube.com/@anna',
  website: 'https://anna.com',
};

// Все треки (только одобренные для отображения в лайкнутых)
export const mockAllTracks = [
  {
    id: '1',
    title: 'Летний дождь',
...
// Треки, загруженные текущим пользователем (с разными статусами)
export const mockMyTracks = [
  {
    id: '101',
    title: 'Мой первый трек',
    artist_name: 'Анна Смирнова',
    created_by: 'user@example.com',
    cover_url: 'https://picsum.photos/200/200?random=101',
    audio_url: 'https://example.com/mytrack1.mp3',
    duration: 215,
    plays_count: 342,
    likes_count: 23,
    genre: 'pop',
  ...
  },
  {
    ...
    audio_url: 'https://example.com/mytrack2.mp3',
    duration: 280,
    plays_count: 156,
    likes_count: 12,
    genre: 'electronic',
  ...
  },
  {
    ...
    audio_url: 'https://example.com/mytrack3.mp3',
    duration: 190,
    plays_count: 0,
    likes_count: 0,
    genre: 'indie',
    status: 'pending',
    created_date: '2025-02-14T09:00:00Z',
  },
  {
    id: '104',
    title: 'Отклонённый трек',
    artist_name: 'Анна Смирнова',
    created_by: 'user@example.com',
    cover_url: 'https://picsum.photos/200/200?random=104',
    audio_url: 'https://example.com/mytrack4.mp3',
    duration: 205,
    plays_count: 0,
    likes_count: 0,
    genre: 'rock',
    status: 'rejected',
    created_date: '2025-01-20T11:20:00Z',
  },
];
